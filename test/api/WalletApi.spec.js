...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Payrobot.WalletApi();
  });
  ...
  describe('WalletApi', function() {
    describe('createWallet', function() {
      it('should call createWallet successfully', function(done) {
        //uncomment below and update the code to test createWallet
        //instance.createWallet(function(error) {
    ...
    describe('createWalletSendRequest', function() {
      it('should call createWalletSendRequest successfully', function(done) {
        //uncomment below and update the code to test createWalletSendRequest
        //instance.createWalletSendRequest(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getWalletHistory', function() {
      it('should call getWalletHistory successfully', function(done) {
        //uncomment below and update the code to test getWalletHistory
        //instance.getWalletHistory(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('getWalletSendRequest', function() {
      it('should call getWalletSendRequest successfully', function(done) {
        //uncomment below and update the code to test getWalletSendRequest
        //instance.getWalletSendRequest(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
