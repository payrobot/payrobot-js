...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Payrobot.WalletCreationInfo();
  });
  ...
  describe('WalletCreationInfo', function() {
    it('should create an instance of WalletCreationInfo', function() {
      // uncomment below and update the code to test WalletCreationInfo
      //var instane = new Payrobot.WalletCreationInfo();
      //expect(instance).to.be.a(Payrobot.WalletCreationInfo);
    });
    ...
    it('should have the property walletPassphrase (base name: "walletPassphrase")', function() {
      // uncomment below and update the code to test the property walletPassphrase
      //var instane = new Payrobot.WalletCreationInfo();
      //expect(instance).to.be();
    });
