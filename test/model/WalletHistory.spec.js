...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Payrobot.WalletHistory();
  });
  ...
  describe('WalletHistory', function() {
    it('should create an instance of WalletHistory', function() {
      // uncomment below and update the code to test WalletHistory
      //var instane = new Payrobot.WalletHistory();
      //expect(instance).to.be.a(Payrobot.WalletHistory);
    });
