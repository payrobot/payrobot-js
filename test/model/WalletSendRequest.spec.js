...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Payrobot.WalletSendRequest();
  });
  ...
  describe('WalletSendRequest', function() {
    it('should create an instance of WalletSendRequest', function() {
      // uncomment below and update the code to test WalletSendRequest
      //var instane = new Payrobot.WalletSendRequest();
      //expect(instance).to.be.a(Payrobot.WalletSendRequest);
    });
