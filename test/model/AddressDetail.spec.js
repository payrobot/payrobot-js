...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Payrobot.AddressDetail();
  });
  ...
  describe('AddressDetail', function() {
    it('should create an instance of AddressDetail', function() {
      // uncomment below and update the code to test AddressDetail
      //var instane = new Payrobot.AddressDetail();
      //expect(instance).to.be.a(Payrobot.AddressDetail);
    });
