...
/**
 * The AddressDetail model module.
 * @module model/AddressDetail
 * @version 1.0
 */
class AddressDetail {
    /**
     * Constructs a new <code>AddressDetail</code>.
     * @alias module:model/AddressDetail
     */
    constructor() { 
        
        AddressDetail.initialize(this);
    }
    ...
    /**
     * Constructs a <code>AddressDetail</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/AddressDetail} obj Optional instance to populate.
     * @return {module:model/AddressDetail} The populated <code>AddressDetail</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AddressDetail();
 ...
 */
AddressDetail.prototype['address'] = undefined;

/**
 * Amount
 * @member {String} amount
 */
AddressDetail.prototype['amount'] = undefined;
