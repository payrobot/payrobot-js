...
/**
 * The WalletHistory model module.
 * @module model/WalletHistory
 * @version 1.0
 */
class WalletHistory {
    /**
     * Constructs a new <code>WalletHistory</code>.
     * @alias module:model/WalletHistory
     */
    constructor() { 
        
        WalletHistory.initialize(this);
    }
    ...
    /**
     * Constructs a <code>WalletHistory</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/WalletHistory} obj Optional instance to populate.
     * @return {module:model/WalletHistory} The populated <code>WalletHistory</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WalletHistory();
 ...
 */
WalletHistory.prototype['currency'] = undefined;

/**
 * ID of the queried wallet
 * @member {String} walletId
 */
WalletHistory.prototype['walletId'] = undefined;

/**
 * List of transactions
 * @member {Array.<module:model/WalletTransaction>} transactions
 */
WalletHistory.prototype['transactions'] = undefined;

/**
 * `true` is there was a problem. `false` if not 
 * @member {Boolean} error
 */
WalletHistory.prototype['error'] = undefined;
