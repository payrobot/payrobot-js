    ...
    static constructFromObject(data, obj) {
        if (data) {
            ...
            if (data.hasOwnProperty('addresses')) {
                obj['addresses'] = ApiClient.convertToType(data['addresses'], [AddressDetail]);
            }
 ...
 * @member {Array.<module:model/AddressDetail>} addresses
 */
WalletTransaction.prototype['addresses'] = undefined;

/**
 * Timestamp of the transaction expressed in `Unix Timestamp`
 * @member {Number} timestamp
 */
WalletTransaction.prototype['timestamp'] = undefined;
